...
(async () => {
  ...
  try {
    ...
    const headingBox = await page.locator('#auctionPage .inspection-heading').boundingBox();
    const fieldsBox = await page.locator('#auctionPage .inspection-list').boundingBox();
