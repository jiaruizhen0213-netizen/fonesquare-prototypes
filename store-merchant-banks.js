...
(function () {
  ...
  function editStore(id){
    ...
    q('managed-useVerifiedAddress').onclick=()=>{q('managed-address').value='18, Jalan Teknologi 3/6, Kota Damansara, 47810 Petaling Jaya, Selangor';q('managed-phone').value='+60 12-345 6789';};
    q('saveManagedStore').onclick=()=>{
      ...
      try{
        ...
        Object.assign(store,{name,phone,address,country:q('managed-country').value});
