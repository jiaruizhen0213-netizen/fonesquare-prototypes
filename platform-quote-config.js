...
(function(w){
 ...
 const page=d.createElement('section');page.className='page';page.id='quoteConfigPage';page.innerHTML='<iframe title="自营阶梯报价配置" src="quote-config.html?embed=1&v=20260917-5" style="width:100%;min-height:850px;border:0;background:transparent" loading="lazy"></iframe>';pageAnchor.after(page);
